...
import {getLeaves, approveLeave, rejectLeave} from '../../redux/slices/leave';
// components
...
const TABLE_HEAD = [
    ...
    {id: 'leave_type_id', label: 'Leave type ID', align: 'left'},
...
export default function LeaveListPage() {
    ...
    const [tableData, setTableData] = useState(leaves);
    ...
    useEffect(() => {
        dispatch(getLeaves(rowsPerPage, page + 1));
        if (leaves.length > 0) {
            setTableData(leaves);
        }
        setTableData(leaves);
            ...
            <Container maxWidth={themeStretch ? false : 'lg'}>
                <CustomBreadcrumbs
                    ...
                    links={[
                        ...
                        {name: 'Leave', href: PATH_DASHBOARD.leave.root},
                        {name: 'List'},
                    ]}
                    action={
                        user?.user.role === 'user' && (
                            <Button
                                ...
                                to={PATH_DASHBOARD.leave.create}
                                variant="contained"
