...
// sections
import {BenefitTableRow, BenefitTableToolbar} from "../../sections/dashboard/benefit/list";
// ----------------------------------------------------------------------
...
const TABLE_HEAD = [
    ...
    {id: 'health_insurance', label: 'Health insurance', align: 'left'},
    {id: 'dental_insurance', label: 'Dental insurance', align: 'left'},
    {id: 'vision_insurance', label: 'vision insurance', align: 'left'},
    {id: 'retirement_plan', label: 'Retirement plan', align: 'left'},
    {id: 'vacation_days', label: 'Vacation days', align: 'left'},
...
export default function BenefitListPage() {
    ...
    const [tableData, setTableData] = useState(benefits);
    ...
    useEffect(() => {
        dispatch(getBenefits(rowsPerPage, page + 1));
            ...
            <Container maxWidth={themeStretch ? false : 'lg'}>
                <CustomBreadcrumbs
                    ...
                    links={[
                        ...
                        {name: 'Benefit', href: PATH_DASHBOARD.benefit.root},
                        {name: 'List'},
                    ]}
                    action={
                        <Button
                            component={RouterLink}
                            to={PATH_DASHBOARD.benefit.create}
                            variant="contained"
