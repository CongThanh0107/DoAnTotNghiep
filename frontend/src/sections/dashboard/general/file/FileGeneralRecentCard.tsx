...
export default function FileGeneralRecentCard({ file, onDelete, sx, ...other }: Props) {
    ...
    <>
      <Stack
        ...
        sx={{
          ...
          borderRadius: 2,
          position: 'relative',
          border: (theme: object|any) => `solid 1px ${theme.palette.divider}`,
          '&:hover': {
      ...
      >
        ...
        {isDesktop && (
          ...
          >
            {file?.shared?.map((person: object|any) => (
